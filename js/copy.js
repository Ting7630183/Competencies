...
var leadership = 0;
var metacognition = 0;
var growth_mindset = 0;

function get_intput_score(){
    creativity = document.getElementById("Creativity").value
    critical_thinking = document.getElementById("Critical-thinking").value
    ...
    curiousity = document.getElementById("Curiousity").value
    ...
    growth_mindset = document.getElementById("Growth-Mindset").value
}
...
function calculate_output_score1() {
    ...
    var starting_score = [creativity, critical_thinking,communication,collaboration, mindfulness, curiousity, courage, resilience, ethics, leadership,metacognition, growth_mindset]
    if(persona === 'Anouchig') {
